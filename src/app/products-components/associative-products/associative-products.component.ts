...
@Component({
  selector: 'app-associative-products',
  templateUrl: './associative-products.component.html',
  styleUrls: ['./associative-products.component.css']
})
/** AssociativeProducts component*/
export class AssociativeProductsComponent {
  /** AssociativeProducts ctor */
  // for wishlist
  public pId: number = 0;
  ...
  constructor(private readonly productService: ProductService,
    ...
    this.AssociativeProductList(routeParams.url);
  ...
  AssociativeProductList(url: string) {
    this.productService.AssociativeProductList(url).subscribe(
      data => {
        this.products = data;
      });
  }
